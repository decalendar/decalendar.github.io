...
{{< arrow from="-7.3,205.2" to="127.3,201.1" control1="9,209.3" control2="123.2,217.4" color="#e60000" label="so cool!" position="absolute" >}}

{{< arrow from="660.1,195" to="504.6,225.6" position="absolute" >}}

{{< arrow from="476,70.6" to="429.1,148.1" control1="400.6,70.6" control2="510.7,111.4" position="absolute" >}}


::: {.absolute width="204px" height="102px" left="626.5px" top="186.6px" style="transform: rotate(34.3deg);"}
Math
:::

::: {.absolute width="204px" height="102px" left="484.5px" top="-11.4px" style="transform: rotate(-23.5deg);"}
Slides
:::

::: {.absolute width="204px" height="102px" left="-60.2px" top="172.1px"}
👍
:::
...
::: {layout-ncol="2"}
![](images/moon.png){.absolute width="400px" height="400px" left="0px" top="0px"}

![](images/sky.png){.absolute width="450px" height="0px" left="0px" top="0px"}
:::
...
::: {layout="[1, 20]"}
![](images/presentation-menu.png){.absolute width="300px" height="0px" left="0px" top="0px"}
...
::: {layout="[1, 20]"}
![](images/presentation-chalkboard.png){.absolute width="0px" height="0px" left="0px" top="0px"}

Use the chalkboard button at the bottom left of the slide to toggle the chalkboard.
:::

::: {layout="[1, 20]"}
![](images/presentation-notes-canvas.png){.absolute width="0px" height="0px" left="0px" top="0px"}
...
press {{< kbd s >}} (or use the tools in presentation menu ![](../images/navigation-menu-icon.png){.absolute width="0px" height="0px" left="0px" top="0px"}) to open speaker view

![](images/speaker-view.png){.absolute width="0px" height="0px" left="0px" top="0px"}
...
Press {{< kbd r >}} (or use the tools in presentation menu ![](../images/navigation-menu-icon.png){.absolute width="0px" height="0px" left="0px" top="0px"}) to open scroll view
